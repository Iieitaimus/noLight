...
class LitObject(Entity):
    def __init__(self, model='cube', scale=1, position=(0, 0, 0), rotation=(0, 0, 0), texture=None, collider=None,
        ...
        if normalMap == None: normalMap = Texture("assets/textures/default_norm.png")
        if specularMap == None: specularMap = Texture("assets/textures/default_spec.png")
        if water:
            normalMap = Texture("assets/textures/water_norm.png")
            smoothness = 512
